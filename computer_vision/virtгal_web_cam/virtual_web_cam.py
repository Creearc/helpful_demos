...
face_close = cv2.imread("p1.jpg")
face_open = cv2.imread("p2.jpg")
face_sad = cv2.imread("w3.jpg")
        ...
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                for face_landmarks in results.multi_face_landmarks:
                    ...
                    sad = (
                        face_landmarks.landmark[8].y - face_landmarks.landmark[52].y
                    )
                    if mouth_open > 0.015:
                        face_img = face_open.copy()
##                    elif sad > 0.02:
##                        face_img = face_sad.copy()
                    else:
