...
- базовая обработка кадра (basic_frame_processing):
  + [ ] basic_opencv
    ...
    - [ ] описания
  + [ ] cv_functions
    - [x] 7) Исправление рыбьего глаза
    - [x] 8) Ресайз?
    - [x] 9) Замена области изображения другим изображением
    - [x] 10) Поворот изображения (афинное преобразование)
    - [x] 11) Реструктуризация Bounding box
    - [x] 12) hsv_threshold
    - [ ] описания
  + [ ] custom_filters
    - [x] 13) сглаживание по Гауссу
    - [x] 14) Глобальный контраст
    - [x] 15) разностное сглаживание
    - [x] 16) медианный фильр
    - [ ] 17) разностные фильтры
    - [ ] описания
  + [ ] тесты
